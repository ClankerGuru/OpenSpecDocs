...
Official documentation website for OpenSpec, a spec-driven development tool for AI coding assistants. Provides installation guides, CLI reference, workflow documentation, and integration instructions for 20+ AI tools including Claude Code, Cursor, Windsurf, and Cline.
## Requirements
